...
const UserLogin = () => {
    ...
    return (
        <div className='flex items-center justify-center flex-col relative h-[100vh] linear-background'>
            <div className="py-[100px] px-10 bg-white shadow-md rounded-md flex flex-col items-center flex-wrap">
                ...
                <form>
                        ...
                        typeUser === "1" ?
                            <>
                                ...
                                <div>
                                    ...
                                    <input className='w-full p-3 border border-[#002849] rounded-sm text-[10pt] focus:outline-none focus:border focus:border-[#002849] opacity-50 transition-[2s]' type="text" placeholder="Insira aqui o seu número de estudante" />
                                </div>
                                <div>
                                    <label>Senha de acesso</label>
                                    <input className='w-full p-3 border border-[#002849] rounded-sm text-[10pt] focus:outline-none focus:border focus:border-[#002849] opacity-50 transition-[2s]' type="password" placeholder="sua palavra pass" />
                                </div>
                            </> : null
                    }
                    {
                        ...
                        typeUser === "2" ?
                            <>
                                <div>
                                    ...
                                    <input className='w-full p-3 border border-[#002849] rounded-sm text-[10pt] focus:outline-none focus:border focus:border-[#002849] opacity-50 transition-[2s]' type="text" placeholder="Insira aqui o seu número de telefone" />
                                </div>
                                <div>
                                    <label>Senha de acesso</label>
                                    <input className='w-full p-3 border border-[#002849] rounded-sm text-[10pt] focus:outline-none focus:border focus:border-[#002849] opacity-50 transition-[2s]' type="password" placeholder="sua palavra pass" />
                    ...
                    <div className="flex flex-col items-center text-center text-xs">
                        <button className='bg-blue-950 py-[1.5rem] px-[8rem] text-white rounded-lg mt-[50px]'>
