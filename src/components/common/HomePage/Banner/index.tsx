    ...
    return (
        <div className="w-full h-[100vh] relative">
            ...
            <div className='absolute mt-24 w-full h-full text-center top-0 flex flex-col justify-center items-center text-white'>
                <h1 className='w-[700px]'>P.I.A. O sistema que visa melhorar a forma de pagamento do sistema de ensino angolano</h1>
                ...
                <div className='flex flex-row items-center justify-around gap-10 pt-10'>
                    <Link to={``} className='py-4 px-12 rounded-sm text-white text-lg border border-[#00A3E6] bg-[#00A3E6]'>Saiba Mais</Link>
                    <Link to={``} className='py-4 px-10 rounded-sm text-white text-lg border border-white hover:bg-white hover:text-[#00A3E6] duration-500'>Contacte-nos</Link>
                </div>
            </div>
        </div>
    )
