            ...
            <div className="w-[80%] mt-10">
                <div className="grelha w-full">
                    ...
                    <div className="w-full flex flex-col gap-5 h-[450px] border rounded-sm shadow-md p-5">
                        ...
                        <div className="text-center flex flex-col gap-4 text-[14px] text-gray-500">
                            <p>Free installation</p>
                            <p>Up to 15 Mpbs download speed</p>
                            <p>Unlimited data usages</p>
                            <p>01 year pricing lock guarantee</p>
                            <p>Unlimited bandwidth</p>
                        </div>
                        <div className="text-center gap-0">
                            <h1 className="text-[#00A3E6]">12.50</h1>
                            <p className="text-gray-400 text-[11px]">/MONTHLY</p>
                        </div>
                        <div className="w-full flex items-center justify-center ">
                            <button className="py-2 px-5 bg-[#00A3E6] text-white rounded-sm">Order This Plan</button>
                        </div>
                    </div>
                    ...
                    <div className="w-full flex flex-col gap-5 h-[450px] border rounded-sm shadow-md p-5">
                        ...
                        <div className="text-center flex flex-col gap-4 text-[14px] text-gray-500">
                            <p>Free installation</p>
                            <p>Up to 25 Mpbs download speed</p>
                            <p>Unlimited data usages</p>
                            <p>02 year pricing lock guarantee</p>
                            <p>Unlimited bandwidth</p>
                        </div>
                        <div className="text-center gap-0">
                            <h1 className="text-[#00A3E6]">24.50</h1>
                            <p className="text-gray-400 text-[11px]">/MONTHLY</p>
                        </div>
                        <div className="w-full flex items-center justify-center ">
                            <button className="py-2 px-5 bg-[#00A3E6] text-white rounded-sm">Order This Plan</button>
                    ...
                    <div className="w-full flex flex-col gap-5 h-[450px] border rounded-sm shadow-md p-5">
                        ...
                        <div className="text-center flex flex-col gap-4 text-[14px] text-gray-500">
                            <p>Free installation</p>
                            <p>Up to 30 Mpbs download speed</p>
                            <p>Unlimited data usages</p>
                            <p>03 year pricing lock guarantee</p>
                            <p>Unlimited bandwidth</p>
                        </div>
                        <div className="text-center gap-0">
                            <h1 className="text-[#00A3E6]">49.50</h1>
                            <p className="text-gray-400 text-[11px]">/MONTHLY</p>
                        </div>
                        <div className="w-full flex items-center justify-center ">
                            <button className="py-2 px-5 bg-[#00A3E6] text-white rounded-sm">Order This Plan</button>
                    ...
                    <div className="w-full flex flex-col gap-5 h-[450px] border rounded-sm shadow-md p-5">
                        ...
                        <div className="text-center flex flex-col gap-4 text-[14px] text-gray-500">
                            <p>Free installation</p>
                            <p>Up to 39 Mpbs download speed</p>
                            <p>Unlimited data usages</p>
                            <p>04 year pricing lock guarantee</p>
                            <p>Unlimited bandwidth</p>
                        </div>
                        <div className="text-center gap-0">
                            <h1 className="text-[#00A3E6]">79.50</h1>
                            <p className="text-gray-400 text-[11px]">/MONTHLY</p>
                        </div>
                        <div className="w-full flex items-center justify-center ">
                            <button className="py-2 px-5 bg-[#00A3E6] text-white rounded-sm">Order This Plan</button>
