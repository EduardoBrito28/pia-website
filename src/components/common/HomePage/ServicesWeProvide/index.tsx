...
export function ServiceWeProvide() {
    return (
        <div className="w-full h-[600px] flex flex-col items-center justify-center gap-5">
            <div data-aos="zoom-in" className="w-full flex flex-col items-center justify-center gap-5">
            ...
            <div className="w-full flex flex-row gap-5 px-40 mt-10 grelha">
                <div data-aos-delay="200" data-aos="fade-down" className="w-full border border-gray-400 h-[280px] flex flex-col items-center justify-center text-gray-200 gap-3 p-2">
                ...
                <div data-aos-delay="400" data-aos="fade-down" className="w-full border border-gray-400 h-[280px] flex flex-col items-center justify-center text-gray-200 gap-3 p-2">
                ...
                <div data-aos-delay="600" data-aos="fade-down" className="w-full border border-gray-400 h-[280px] flex flex-col items-center justify-center text-gray-200 gap-3 p-2">
                ...
                <div data-aos-delay="800" data-aos="fade-down" className="w-full border border-gray-400 h-[280px] flex flex-col items-center justify-center text-gray-200 gap-3 px-10">
